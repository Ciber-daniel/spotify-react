    ...
    <div className="search-page">
      ...
      {tracksData?.items && (
        <div className="home-tracks-container ">
          ...
          <Button onClick={() => loadMoreData(tracksData, "tracks")}>
      ...
      {albumsData?.items && (
        <div className="home-albums-container">
          ...
          <Button onClick={() => loadMoreData(albumsData, "albums")}>
            Cargar más álbumes
          </Button>
        </div>
      )}
      ...
      {artistsData?.items && (
        <div className="home-artists-container">
          ...
          <Button onClick={() => loadMoreData(artistsData, "artists")}>
            Cargar más artistas
          </Button>
        </div>
      )}
      ...
      {playlistsData?.items && (
        <div className="home-playlists-container">
          ...
          <Button onClick={() => loadMoreData(playlistsData, "playlists")}>
